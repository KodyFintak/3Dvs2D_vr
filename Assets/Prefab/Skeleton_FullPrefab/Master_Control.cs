...
//	}
	...
	IEnumerator SleepForDeath(){
		...
		if (5 == Random.Range (1, 50)) {
			PhotonNetwork.Instantiate ("Bottle_Mana", transform.position, Quaternion.identity, 0);
		} else if (10 == Random.Range (1, 50)) {
			PhotonNetwork.Instantiate ("Bottle_Health", transform.position, Quaternion.identity, 0);
		}
		// ***************************************************************************************
	}
